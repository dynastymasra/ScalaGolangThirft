...
// UpdateUserService func used to get service user ping response
func UpdateUserService(id user.UUID, data *user.Identity) (*user.Identity, error) {
	...
	result, err := client.Update(id, data)
	if err != nil {
		log.Error(err)
		return nil, err
	}
